  ...
  <div class="">
    ...
    <div class="clearfix"></div>
      ...
      <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
          <div class="x_title">
            <h2><i class="fa fa-file-text"></i>  REPORTE DE PROVEEDORES</h2>
              ...
              <div class="col-sm-12">
                ...
                <div class="card-box table-responsive">
                    <?php
                        ...
                        ?>
                        <br><br>
                    <?php echo form_open_multipart('reporte/proveedoresPdf'); ?>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo formatearSoloFecha($row->fechaRegistro); ?>

  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        <h3><i class="fa fa-users"></i> CATEGORIA</h3>
      </div>
    ...
    <div class="clearfix"></div>
      ...
      <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
          <div class="x_title">
            <h2><i class="fa fa-users"></i> Insertar nuevo categoria</h2>
                  ...
                  <div class="card-box">
                    <div class="btn-group">
                      ...
                      <button type="submit" name="buttonInhabilitados" class="btn btn-outline-success">
                        <i class="fa fa-arrow-circle-left"></i> Volver a categorias
                      </button>
                      <?php 
                        echo form_close();
                      ?>
                    ...
                    <p class="text-muted font-13 m-b-30">
                      Usted va a insertar un nuevo categoria, por favor llene el siguiente campo:
                    </p>
                    <?php 

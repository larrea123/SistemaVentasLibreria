   ...
   <script src="<?php echo base_url(); ?>gentelella/vendors/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <!-- ECharts -->
    <script src="<?php echo base_url(); ?>gentelella/vendors/echarts/dist/echarts.min.js"></script>
    <script src="<?php echo base_url(); ?>gentelella/vendors/echarts/map/js/world.js"></script>
  </body>   
</html>